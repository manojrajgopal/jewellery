...
const SHORTCUTS: Shortcut[] = [
  ...
  { keys: ['G', 'L'], label: 'Go to the lookbook', group: 'Discover' },
  { keys: ['G', 'J'], label: 'Go to the journal', group: 'Discover' },
  { keys: ['G', 'E'], label: 'Go to the stone library', group: 'Discover' },
  { keys: ['G', 'R'], label: 'Go to care & sizing', group: 'Discover' },
  { keys: ['W'], label: 'Open saved pieces', group: 'View' },
  { keys: ['X'], label: 'Open the comparison table', group: 'View' },
  { keys: ['O'], label: 'Open the concierge', group: 'View' },
